...
with sync_playwright() as pw:
 ...
 # Fixed + always available with correct actual/planned context.
 ...
 check('Plus on Actuals selects actual context',page.locator('[data-add-context="actual"]').get_attribute('aria-pressed')=='true')
 ...
 tab('plan');page.locator('#quickAddBtn').click();page.locator('[data-add-context="actual"]').click();check('Quick-add context can be changed without dismissing menu',page.locator('#quickAddMenu').is_visible() and page.locator('[data-add-context="actual"]').get_attribute('aria-pressed')=='true')
