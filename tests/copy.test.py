"""v1.1.1 bilingual user-copy regression checks.
...
check('Release and cache identify v1.1.1','v1.1.1 · inbacklog' in html and 'homeflow-static-v1.1.1' in (BASE/'sw.js').read_text())
with sync_playwright() as pw:
    ...
    page.screenshot(path=str(OUT/'Homeflow_v1.1.1_Welcome_Desktop.png'),full_page=False)
    page.set_viewport_size({'width':390,'height':844})
    page.screenshot(path=str(OUT/'Homeflow_v1.1.1_Welcome_Mobile.png'),full_page=False)
