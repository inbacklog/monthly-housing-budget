...
with sync_playwright() as pw:
    ...
    tab('plan');page.locator('[data-action="add-plan"]').click()
    page.locator('#entryType').select_option('income');page.locator('#entryLabel').fill('Custom income');page.locator('#entryAmount').fill('1234.56');page.locator('#entryCategory').select_option('income');submit()
    check('Arbitrary income amount accepted',get()['lines'][-1]['amount']==1234.56)
    page.locator('[data-action="add-plan"]').click();page.locator('#entryLabel').fill('<img src=x onerror=alert(1)>');page.locator('#entryAmount').fill('42.75');page.locator('#entryCategory').select_option('__new');page.locator('#customCategory').fill('Custom category');submit()
