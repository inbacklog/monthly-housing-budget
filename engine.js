...
return Object.freeze({CATEGORIES,TYPES,FREQ,CSV_COLS,MAX_ITEMS,MAX_AMOUNT,blank,demo,clone,id,monthNow,isMonth,isDate,addMonth,validate,equivalent,budget,actual,allocation,forecast,parseCSV,importCSV,exportCSV,anonymize,csvEscape});
});
